    ...
    function card(car, index){
      ...
      el.innerHTML = `
        ...
        <div class="car-body">
          ...
          <div class="chips">
            <span class="chip" aria-label="${car.seats} seats">👤 ${car.seats}</span>
            <span class="chip" aria-label="${car.doors} doors">🚪 ${car.doors}</span>
            <span class="chip" aria-label="${car.transmission}">⚙️ ${car.transmission}</span>
          </div>
